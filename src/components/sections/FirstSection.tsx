...
const FirstSection: React.FC = () => {
  const items = [
    ...
    <FirstSecCard key="oculus" id="oculus" image={oculus} label="oculus" />,
    <FirstSecCard key="playstation" id="playstation" image={playstation} label="PlayStation" />,

    <FirstSecCard key="nintendo" id="nintendo" image={nintendo} label="nintendo" />,
    <FirstSecCard key= "headset" id="headset" image={headset} label="headset" />,
    <FirstSecCard key= "controller" id="controller" image={controller} label="controller" />,
  ]
  return (
    <Box p={5} >
